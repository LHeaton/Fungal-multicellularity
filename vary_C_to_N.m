...
figure(1)
semilogx(C_to_N_vector, Mu_motile*24, 'c', 'LineWidth', 2)
hold on
semilogx(C_to_N_vector, Mu_autolytic*24, 'g', 'LineWidth', 2)
semilogx(C_to_N_vector, Mu_fungal*24, 'm', 'LineWidth', 2)
semilogx(C_to_N_vector, Mu_immobile*24, 'k--', 'LineWidth', 2)
xlabel('C:N ratio')
ylabel('Apparent growth rate, day^{-1}')
legend('Motile cells', 'Autolytic cells', 'Fungi', 'Immobile cells')
 
figure(2)
semilogx(C_to_N_vector, D_motile*(Ci+Ni+Pi)*24, 'c', 'LineWidth', 2)
hold on
semilogx(C_to_N_vector, D_autolytic*(Ci+Ni+Pi)*24, 'g', 'LineWidth', 2)
semilogx(C_to_N_vector, D_fungal*(Ci+Ni+Pi)*24, 'm', 'LineWidth', 2)
semilogx(C_to_N_vector, D_immobile*(Ci+Ni+Pi)*24, 'k--', 'LineWidth', 2)
xlabel('C:N ratio')
